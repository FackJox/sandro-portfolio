...
export default function MotionCarousel(props) {
  ...
  useEffect(() => {
    ...
    document.addEventListener('carousel:mousedown', handleMouseDown);
    document.addEventListener('carousel:mouseup', handleMouseUp);
    document.addEventListener('carousel:mousemove', handleMouseMove);
    document.addEventListener('carousel:touchstart', handleTouchStart);
    document.addEventListener('carousel:touchend', handleTouchEnd);
    document.addEventListener('carousel:touchmove', handleTouchMove);

    return () => {
      document.removeEventListener('carousel:mousedown', handleMouseDown);
      document.removeEventListener('carousel:mouseup', handleMouseUp);
      document.removeEventListener('carousel:mousemove', handleMouseMove);
      document.removeEventListener('carousel:touchstart', handleTouchStart);
      document.removeEventListener('carousel:touchend', handleTouchEnd);
      document.removeEventListener('carousel:touchmove', handleTouchMove);
    };
  }, []);
